...
function create_room_id() {
    const adjectives_male = ['velik','mocan','puhast','sijoc','hitri','miroljuben','ucljiv','igriv','neustrasen','zvest','lep','plemenit','mogocen','srckan','prijazen','previden','potrpezljiv','razigran','pozrtvovalen','pameten'];
    const adjectives_female = ['puhasta','hitra','ljubka','udobna','elegantna','vzdrzljiva','zvesta','igriva','miroljubna','nezna','previdna','prijazna','graciozna','sramezljiva','ucljiva','radoziva','ustvarjalna','zgovorna','prilagodljiva','skrbna'];
    const animals_male = ['lev','konj','orel','ptic','tiger','medved','volk','slon','svizec','kos']
    const animals_female = ['svinja','koza','kokos','ovca','kokoska','krava','pcela','macka','kobila','opica','medvedka','kokos']
