...
<div hidden={round_type_game(game_state.new_round.round_type) !== NewRoundType.Rocno}>
    <h3>Točke</h3>
    {#each data.room.player_names as player_name, i}
...
<div hidden={round_type_game(game_state.new_round.round_type) !== NewRoundType.Osnovno}>
    ...
    <label for="trula_izgubljena">Izgubljena</label>
    <input type="radio" bind:group={game_state.new_round.osnovno.trula} value={Realizacija.Brez} id="trula_brez">
    <label for="trula_brez">Brez</label>
    <input type="radio" bind:group={game_state.new_round.osnovno.trula} value={Realizacija.Narejena} id="trula_narejena">
    <label for="trula_narejena">Narejena</label>

    <h3>Kralji</h3>
    <input type="radio" bind:group={game_state.new_round.osnovno.kralji} value={Realizacija.Izgubljena} id="kralji_izgubljeni">
    <label for="kralji_izgubljeni">Izgubljeni</label>
    <input type="radio" bind:group={game_state.new_round.osnovno.kralji} value={Realizacija.Brez} id="kralji_brez">
    <label for="kralji_brez">Brez</label>
    <input type="radio" bind:group={game_state.new_round.osnovno.kralji} value={Realizacija.Narejena} id="kralji_narejeni">
    <label for="kralji_narejeni">Narejeni</label>

    <h3>Pagat ultimo</h3>
    <input type="radio" bind:group={game_state.new_round.osnovno.pagat_ultimo} value={Realizacija.Izgubljena} id="pagat_ultimo_izgubljen">
    <label for="pagat_ultimo_izgubljen">Izgubljen</label>
    <input type="radio" bind:group={game_state.new_round.osnovno.pagat_ultimo} value={Realizacija.Brez} id="pagat_ultimo_brez">
    <label for="pagat_ultimo_brez">Brez</label>
    <input type="radio" bind:group={game_state.new_round.osnovno.pagat_ultimo} value={Realizacija.Narejena} id="pagat_ultimo_narejen">
    <label for="pagat_ultimo_narejen">Narejen</label>

    <h3>Kralj ultimo</h3>
    <input type="radio" bind:group={game_state.new_round.osnovno.kralj_ultimo} value={Realizacija.Izgubljena} id="kralj_ultimo_izgubljen">
    <label for="kralj_ultimo_izgubljen">Izgubljen</label>
    <input type="radio" bind:group={game_state.new_round.osnovno.kralj_ultimo} value={Realizacija.Brez} id="kralj_ultimo_brez">
    <label for="kralj_ultimo_brez">Brez</label>
    <input type="radio" bind:group={game_state.new_round.osnovno.kralj_ultimo} value={Realizacija.Narejena} id="kralj_ultimo_narejen">
    <label for="kralj_ultimo_narejen">Narejen</label>
...
<div hidden={round_type_game(game_state.new_round.round_type) !== NewRoundType.Opravljanje}>
